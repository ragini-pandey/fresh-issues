...
import { Globe, Menu, Moon, Sun, Zap } from 'lucide-react';
...
function AppContent() {
  ...
  const activeRepoCount = repos.filter((r) => !r.disabled).length;
    ...
    <div className="h-full flex justify-center bg-background">
      <div className="flex h-full w-full md:w-[85%] lg:w-[60%] lg:min-w-[768px] md:border-x border-border relative">
        ...
        <main className="flex-1 flex flex-col overflow-hidden min-w-0">
          ...
          <div
            key={view}
            className="flex-1 flex flex-col overflow-hidden min-w-0 animate-fade-in-up"
          >
            {view === 'issues' ? (
              <IssueList
                issues={issues}
