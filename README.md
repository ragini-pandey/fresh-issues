...
Discover fresh open source issues on GitHub.  
You'll always be ahead of fellow open src contributors.  
Filter by language, labels, time window, stars, and more and then jump straight into contributing.
...
- **Repo tracking** — save specific repos and monitor them for new issues across all of them at once. Drag to reorder and toggle repos on/off without removing them.
- **Sound notifications** — optionally play a sound when new issues are found after a refresh.
...
- **@dnd-kit** for drag-to-reorder repos
...
├── services/
│   ├── github.js           # Public entry-point — re-exports everything
│   ├── github.constants.js # API URLs, throttle/cache settings, UI presets
...
│   ├── github.normalize.js # Query builder, issue normalizers, getTimeAgo
│   └── github.graphql.js   # GraphQL fetchers for issues and repo batches
└── lib/
